      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-6 md:py-0 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <Heading 
              level={1} 
              className="opacity-0 animate-fade-in-up [animation-delay:150ms] text-5xl sm:text-6xl lg:text-7xl font-display tracking-tight text-gray-900 leading-[1.1] drop-shadow-sm mb-6"
            >
              {t("hero.title", "Spark Change on Campus.")}
            </Heading>

            <Text className="opacity-0 animate-fade-in-up [animation-delay:300ms] text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed mb-10">
              {t(
                "hero.subtitle", 
