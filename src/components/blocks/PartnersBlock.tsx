...
export function PartnersBlock() {
  ...
  const partners = [
    { id: 1, logo: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg", alt: "Google Logo" },
    { id: 2, logo: "https://upload.wikimedia.org/wikipedia/commons/5/51/IBM_logo.svg", alt: "IBM Logo" },
    { id: 3, logo: "https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg", alt: "Microsoft Logo" },
    { id: 4, logo: "https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg", alt: "Amazon Logo" },
    { id: 5, logo: "https://upload.wikimedia.org/wikipedia/commons/0/08/Cisco_logo_blue_2016.svg", alt: "Cisco Logo" },
    { id: 6, logo: "https://upload.wikimedia.org/wikipedia/commons/e/e8/Tesla_logo.png", alt: "Tesla Logo" },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 mb-16 pt-8 text-center">
        <FadeIn>
          <Heading level={3} className="text-xl md:text-2xl font-display text-gray-400 uppercase tracking-widest">
            {t("partners.headline", "Supported by our amazing local partners")}
          </Heading>
        </FadeIn>
      </div>
